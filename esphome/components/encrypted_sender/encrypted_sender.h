...
#include "esphome/components/hardware_aes/hardware_aes_cbc.h"
...
class EncryptedSenderComponent : public Component {
 public:
  ...
  void set_aes(hardware_aes::HardwareAESCBCComponent *aes) { aes_ = aes; }
 ...
 protected:
  ...
  hardware_aes::HardwareAESCBCComponent *aes_{nullptr};
